...
public class Visualizzatore extends JFrame {
    ...
    private Color scegliColore(Parco parco, Posizione posizione) {
    	if(parco.getAnimale(posizione)!=null && parco.getAnimale(posizione).getClass() == Rapace.class)
    		return Color.yellow;
    	if(parco.getAnimale(posizione)!=null && parco.getAnimale(posizione).getClass() == Roditore.class)
    		return Color.black;
    	return Color.green;
    }*/
